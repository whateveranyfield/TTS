...
class DurationPredictor(torch.nn.Module):
    ...
    def __init__(
        self, idim, n_layers=2, n_chans=384, kernel_size=3, dropout_rate=0.1, offset=1.0, use_equalizer=False,
    ):
    ...
    def _forward(self, xs, x_masks=None, style=None, is_inference=False):
    ...
    def forward(self, xs, x_masks=None, style=None):
        ...
        """
        return self._forward(xs, x_masks, style, False)

    def inference(self, xs, x_masks=None, style=None):
        """Inference duration.
        ...
        """
        return self._forward(xs, x_masks, style, True)
